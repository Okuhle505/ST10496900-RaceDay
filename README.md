...
The SQL script is the Part 1 hand-in schema; the API uses EF Core code-first mappings matching it. Do not use the sample password hashes to sign in; register accounts through the API.
